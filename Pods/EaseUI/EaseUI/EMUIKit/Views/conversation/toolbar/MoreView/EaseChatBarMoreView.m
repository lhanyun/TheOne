...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _takePicButton.backgroundColor = [UIColor clearColor];
    _maxIndex = 2;
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        _audioCallButton.backgroundColor = [UIColor clearColor];
        ...
        _videoCallButton.backgroundColor = [UIColor clearColor];
        _maxIndex = 4;
