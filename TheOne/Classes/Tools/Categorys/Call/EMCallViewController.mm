...
- (void)initUI {
    ...
    self.speakerOutButton.backgroundColor = [UIColor clearColor];
    self.silenceButton.backgroundColor = [UIColor clearColor];
    self.minimizeButton.backgroundColor = [UIColor clearColor];
    self.rejectButton.backgroundColor = [UIColor clearColor];
    self.hangupButton.backgroundColor = [UIColor clearColor];
    self.answerButton.backgroundColor = [UIColor clearColor];
    self.switchCameraButton.backgroundColor = [UIColor clearColor];
    self.showVideoInfoButton.backgroundColor = [UIColor clearColor];
