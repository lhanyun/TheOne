...
- (void)animateToMenu
{
    ...
    positionTopAnimation.toValue = [NSValue valueWithCGPoint:CGPointMake(CGRectGetMidX(self.bounds),
                                                                         roundf(CGRectGetMinY(self.bounds)+(height/2) + 5))];
    ...
    positionBottomAnimation.toValue = [NSValue valueWithCGPoint:CGPointMake(CGRectGetMidX(self.bounds),
                                                                            roundf(CGRectGetMaxY(self.bounds)-(height/2) - 5))];
...
- (void)setup
{
    ...
    self.topLayer.frame = CGRectMake(0, CGRectGetMinY(self.bounds)+5, width, height);
    ...
    self.bottomLayer.frame = CGRectMake(0, CGRectGetMaxY(self.bounds)-height-5, width, height);
